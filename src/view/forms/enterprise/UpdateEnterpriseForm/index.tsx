...
import { useUpdateEnterpriseForm } from "./useUpdateEnterpriseForm";

interface UpdateEnterpriseFormProps {
    enterprise: Enterprise;
}

export const UpdateEnterpriseForm = ({enterprise}:UpdateEnterpriseFormProps) => {
    const { register, handleSubmit, errors, onSubmit } = useUpdateEnterpriseForm(enterprise);
